...
function db_connect() {
	...
	return $db = new PDO('mysql:host=localhost;dbname='.$_SESSION['dbname'].';charset=utf8', $_SESSION['user'], $_SESSION['pass']);
}
...
function valori_default() {
	...
	$_SESSION['dbname'] 	= 'trans';
	$_SESSION['user'] 	= 'root'; // Locale : root | Online : root
	$_SESSION['pass'] 	= 'craf35aa66'; // Locale : craf35aa66 | Online : VUOTO
